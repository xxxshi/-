 ...
 * @Version: 1.0
 **/
@WebServlet(name="ShowStorageinDetail",urlPatterns = {"/showStorageinDetail"})
public class ShowStorageinDetail extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String storageinSql = "select * from storagein  where storageinid = ?";
        ...
        //进仓详情单里的件号
        ArrayList<ArrayList<Object>> pieceidArrayList = DBUtil.findByParamter("select pieceid from storageinDetail " +
        ...
        for (String materialCodeItem : materialCodeList) {
            ...
            //获得进仓详单里每种物料的件数
            int count = 0;
            String countSql = "select count(*) from storageinDetail where pieceid IN(\n" +
        ...
        req.getRequestDispatcher("/input_view/showSorageinDetail.jsp").forward(req, resp);
    }
}
