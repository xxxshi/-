...
/**
 * @program: erp
 * @description: 不合格的进仓验货详情
 * @author: xxxshi
 * @create: 2018-12-19 02:09
 * @Version: 1.0
 **/
@WebServlet(name = "ShowExaminegoodDetailFailure",urlPatterns = {"/showExaminegoodDetailFailure"})
public class ShowExaminegoodDetailFailure extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(purchaseMes.size()>0){
            ...
            if(supplyResult.size()>0){
                ...
                //获得不合格进仓验货详情单
                String[] storageinidParamterFailure = {storageinid,"0"};
                ArrayList<ArrayList<Object>> arrayListArrayList = DBUtil.findByParamter("select * from examinegoodDetail " +
                        "where storageinid=? and proved=? order by pieceid", storageinidParamterFailure);
                ...
                req.getRequestDispatcher("/input_view/showExaminegoodDetailFailure.jsp").forward(req,resp);
            }
        }
    }
}
