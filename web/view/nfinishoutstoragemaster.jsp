...
<body>
<%
    String sql = "select * from nfinishoutstorage";
...
<center>
    <h1>非分切出仓主表</h1>
    <a href="/nCutOutServlet"><input type="button" value="非分切出仓" > </a>
        ...
        <%
            ...
            for(int i=0; i<Al.size(); i++){
                ...
                for(int j=0; j<Al.get(i).size();j++){
                    out.println("<td>");
                    if(j==1)
                        out.println("<a href='nfinishoutstorage.jsp?oid="+Al.get(i).get(j)+"'>"+Al.get(i).get(j)+"</a>");
                    else
